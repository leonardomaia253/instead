...
const LENDING_DISABLED_MESSAGE =
  "Lending on-chain esta desativado neste ambiente. Configure contratos, rotas e NEXT_PUBLIC_ENABLE_PRODUCTION_LENDING=true apos concluir os gates de producao.";
